...
dotenv.config();
import { startMentorshipNotificationConsumer } from "./consumers/mentorship.consumer.js";
...
const startServer = async () => {
  try {
    ...
    // start consuming mentorship purchase events 

    await startMentorshipNotificationConsumer()
